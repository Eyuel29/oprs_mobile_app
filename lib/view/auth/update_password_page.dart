...
class _UpdatePasswordPageState extends State<UpdatePasswordPage> {
  ...
  Map<String, String> inputErrors = { "oldPassword" : "", "password1": "", "password2": "" };

  @override
  Widget build(BuildContext context) {
    CustomTextInput oldPasswordInput = CustomTextInput(
      ...
      onChanged: (text) {
        setState(() {
          if (text.isNotEmpty && text.length <= 6) {
            inputErrors["oldPassword"] = "Password is weak!";
          } else {
      ...
      errorText: inputErrors["oldPassword"]!.isNotEmpty ? inputErrors["oldPassword"] : null,
    );
  ...
  bool checkEmptyInput() {
    return oldPassword.isEmpty || password1.isEmpty || password2.isEmpty;
  }
